...
from core._7_sub_into_vid import build_cover_bar, trans_backdrop_style, video_encoder_args
...
def merge_video_audio():
    ...
    # Same bitrate matching as the subtitled output; the audio here is a fresh
    # mix, so it always has to be encoded.
    cmd.extend(video_encoder_args(VIDEO_FILE))
    cmd.extend(['-c:a', 'aac', '-b:a', '96k', '-movflags', '+faststart', DUB_VIDEO])
